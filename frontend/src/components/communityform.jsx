...
const Postform = () => {
   ...
   const formik=useFormik({
    ...
    onSubmit:(values, {resetForm, setSubmitting}) => {
        console.log(values);
        axios.post("http://localhost:5000/community/add", values).then((response) => {
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:gap-x-5">
                ...
                <label htmlFor="image" className="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
     Profile
  </label>
  <input
    type="file"
