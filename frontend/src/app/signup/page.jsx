  ...
  return (
    <div>
          ...
          <nav className="relative max-w-[66rem] w-full md:flex md:items-center md:justify-between md:gap-3 ps-5 pe-2 mx-2 lg:mx-auto py-2">
            ...
            <div className="flex items-center justify-between">
              <a
                ...
                aria-label="Brand"
              >
                Ne<span style={{ color: "#4e47eb", fontSize: "23px" }}>X</span>
                us
              </a>
              {/* Collapse Button */}
            ...
            >
              <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                  <Link
                    className="p-2 flex items-center text-sm focus:outline-none focus:text-blue-600 dark:text-blue-500 dark:focus:text-blue-500"
                    href="/"
                    aria-current="page"
                  >
                    <svg
                  ...
                  <div className="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5  md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-300 before:-translate-y-1/2 dark:before:bg-neutral-700">
                    <Link
                      style={{ color: "#4e47eb" }}
                      className="p-2 w-full flex items-center text-sm  focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                      href="/login"
                    >
                      <svg
          ...
          <div className="p-2 border bg-gray-50 rounded-3xl">
                ...
                <form onSubmit={formik.handleSubmit}>
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Xae -12"
                        className="block w-full h-12 px-4 py-2 text-slate-700 duration-200 border rounded-lg appearance-none bg-chalk border-zinc-300 placeholder-zinc-300 focus:border-zinc-300 focus:outline-none focus:ring-zinc-300 sm:text-sm"
                      />
                    ...
                    <div className="col-span-full">
                      <button
                        ...
                        type="submit"
                        className="inline-flex items-center justify-center w-full h-12 gap-3 px-5 py-3 font-medium text-white duration-200 rounded-xl hover:bg-gray-700 focus:ring-2 focus:ring-offset-2 focus:ring-black"
                      >
                        Create Account
                      </button>
                    </div>
                  ...
                  <div className="mt-6">
                    <p
                      ...
                      className="flex mx-auto text-sm font-medium leading-tight text-center"
                    >
                      Already have a account?  <span  style={{color:'#4039a6' }} className="underline"><Link href="/login">Sign In</Link> </span> 
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl font-semibold tracking-tighter text-gray-900 lg:text-5xl">
                <span style={{ color: "#4039a6" }}> Welcome to the Community </span> Create your account
              </h1>
              <p className="mt-4 text-base font-medium text-gray-500 text-pretty">
                A rapid approach to join the community where collaboration meets
                simplicity.
              </p>
            </div>
      ...
      <footer className="bg-none">
        <div className="mx-auto max-w-screen-xl pt-0 px-4 pb-8 md:pt-16 sm:pb-6  lg:px-8 lg:pt-24">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-sm text-gray-500">
              Shape the Future of Connection. And Start Your Journey Today With
              NEXUS!
            </p>
