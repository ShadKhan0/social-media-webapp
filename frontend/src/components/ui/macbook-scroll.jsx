...
import myimg from "../ui/image.png"
...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="md:min-h-[200vh] flex flex-col flex-wrap items-center py-0 md:py-10 sm:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50">
      <motion.h2
        style={{
        ...
        {title || (
          <span>
            Every Connection and Moment<br /> Matters With <span style={{color:'#4e47eb'}}>Nexus!!</span>
          </span>
        )}
      </motion.h2>
      {/* Lid */}
