...
/>
                ...
                <div className="mt-5 flex justify-center gap-x-2">
                  <button
                    ...
                    type="submit"
                    className="py-3 px-12 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                  >
                    Post
                  </button>
                </div>
